const assetPaths = {
    ...
    communityFeedbackProgramIcon: 'public/Assets/two-people-speech-bubble.svg',
    ...
    outfitIcon: `data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white"><path d="M21.6 18.2 13 11.75v-.91c1.65-.49 2.8-2.17 2.35-4.01-.31-1.32-1.4-2.37-2.72-2.66C10.15 3.68 8 5.59 8 8h2c0-1.1.9-2 2-2s2 .9 2 2c0 1.11-.91 2.01-2.02 2H11v2.75L2.4 18.2c-.77.58-.36 1.8.6 1.8h18c.96 0 1.37-1.22.6-1.8zM6 18l6-4.5 6 4.5H6z"></path></svg>')}`,
    outfitFavoriteIcon: `data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 2.5l2.99 6.06 6.69.97-4.84 4.72 1.14 6.66L12 17.77l-5.98 3.14 1.14-6.66-4.84-4.72 6.69-.97z"></path></svg>')}`,
    ...
    blush: 'https://www.rovalra.com/static/icons/png/blush.webp',
    ...
    subplaceBannerIcon: `data:image/svg+xml,${encodeURIComponent('<svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-1phnduy" focusable="false" aria-hidden="true" viewBox="0 0 24 24"><path d="M13 22h8v-7h-3v-4h-5V9h3V2H8v7h3v2H6v4H3v7h8v-7H8v-2h8v2h-3z"></path></svg>')}`,
    ...
    chevronLeftIcon: `data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M15.41 7.41 14 6l-6 6 6 6 1.41-1.41L10.83 12z"></path></svg>')}`,
    chevronRightIcon: `data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"></path></svg>')}`,

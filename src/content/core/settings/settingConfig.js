...
export const SETTINGS_CONFIG = {
    ...
    FunStuff: {
        ...
        settings: {
            fakeBanGenerator: {
                label: 'Mock Moderation Screen Generator',
                description: [
                    'Generate a fake Roblox-style moderation screen for fun. This is purely cosmetic and does **not** issue any real moderation action, ban, or warning on your account.',
                ],
                type: 'banGenerator',
                default: null,
                banDurations: [
                ...
                moderatorNotes: {
                    ...
                    'Harassment': 'Roblox does not permit bullying or harrassment towards community members.',
                    'Spam': 'Roblox does not permit spamming in the form of clickbait, or repetitive, large volume messaging.',
                    'Advertisement': 'Roblox does not allow this type of advertisement. Please ensure your ad content complies with the Roblox Advertising Standards.',
                    ...
                    'Adult Content': 'Roblox does not permit sexual content in any form on the platform.',
                    'Inappropriate': 'Your account has been suspended for creating, promoting, or participating in inappropriate behavior or content. This is a violation of our Terms of Use.',
                    'Privacy': 'Roblox does not permit sharing Personal Identifiable Information in the form of full name, email address, passwords, physical address, telephone numbers, images of themselves, or unauthorized voice recordings of minors.',
                    'Minor Swearing': 'Roblox does not permit profane language or slurs.',
                    ...
                    'Dating Imagery': 'Roblox does not permit dating or romantic exchanges between avatars.',
                    'DMCA': 'Your account has been closed due to violations of our DMCA Repeat Infringer Policy. Please review our Terms of Service for additional information.',
                    'Gang Images': 'Roblox does not permit discriminatory language, behavior, or content of any kind.',
                    'Personal Attack/Harassment/Bullying': 'Roblox does not permit bullying or harrassment towards community members.',
                    'Clickbait Ads': 'Roblox does not permit spamming in the form of clickbait, or repetitive, large volume messaging.',
                    'Inappropriate Content': 'Your account has been suspended for creating, promoting, or participating in inappropriate behavior or content. This is a violation of our Terms of Use.',
                    'Not Related to Roblox': 'Your account has been suspended for violating our Terms of Use.',
                    'Off-Site Links': 'Roblox does not permit the use of off-site links of any kind. Links to Guilded, YouTube, Facebook, Discord, Twitter, and Twitch must be wrapped in the applicable Policy API or listed in the Social Networks and Social Links settings of your profile or experience description page.',
                    'Hidden Message Clothing': 'Your account has been suspended for creating, promoting, or participating in inappropriate behavior or content. This is a violation of our Terms of Use.',
                    'Account Theft': 'Your account has been deleted for violating the Terms of Service for account theft.',
                    'Compromised Account': "Your account has been deleted for theft of an account and/or its assets.",
                    'Copyright/DMCA': 'Roblox does not permit users to violate intellectual property rights.',
                    'Exploiting': 'Roblox does not permit the use of third-party software to modify the client.',
                    'Text Filter / Profanity': 'Roblox does not permit profane language or slurs.',
                    'Illicit Substance': 'Roblox does not permit illegal or regulated content in any form. This can include alcohol, drugs, tobacco products, or bomb or weapon making.',
                    'Malicious': 'Roblox does not permit bypasses of our systems that keep our platform and community safe and secure.',
                    'Misleading': "Roblox does not permit users to mislead others by impersonating other people's real- or virtual-world identity or affiliations.",
                    'Dating': 'Roblox does not permit dating or romantic exchanges between avatars.',
                    'Phishing/Scam': 'Roblox does not permit phishing or scamming links, requests for passwords, selling of accounts, uploading of unauthorized accounts, selling Roblox assets for real money off platform, or artificially inflating numbers associated with experiences.',
                    'Real Info': 'Roblox does not permit the exchange of Personal Identifiable Information (PII) between community members.',
                    'RMT': 'Roblox does not permit using third-parties to buy, sell, or trade Robux, promotional codes that falsely appear to be from Roblox Corporation, or inappropriate use of the group payout system.',
                    'Shock': 'Your account has been suspended for creating, promoting, or participating in inappropriate behavior or content. This is a violation of our Terms of Use.',
                    'Threats': 'Roblox does not permit real threats of violence towards members of the Roblox Community.',
                    ...
                    'Politics': 'Roblox does not permit support for current political candidates, parties, associated flags or symbols.',
                    'Encouraging Dangerous Behavior': 'Roblox does not permit the encouragement of or participation in real-life dangerous activities among community members.',
                    ...
                    'Child Endangerment': 'Roblox does not permit sexual content in any form on the platform.',
                    'Real-Life Threats': 'Roblox does not permit real life threats or abuse of any Roblox Employees, Contractors, or Affiliates.',
                    ...
                    'Contests and Sweepstakes': 'Roblox does not permit phishing or scamming links, requests for passwords, selling of accounts, uploading of unauthorized accounts, selling Roblox assets for real money off platform, or artificially inflating numbers associated with experiences.',
                    ...
                    'Intellectual Property Violation': 'Roblox does not permit users to violate intellectual property rights.',
                    'Off Platform Speech and Behavior': 'Your account has been suspended for violating our Terms of Use.',
                    ...
                    'Chargeback': 'Your account has been moderated because one or more of the charges on the account were reported as unauthorized or disputed by the billing account holder.',
